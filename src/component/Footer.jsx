...
export default function footer() {
  ...
  <div className="contact-info">
    ...
    <a href="mailto:aditi@example.com">aditi@example.com</a>
  </div>

  <p className="connect-text">Let's connect on social media!</p>
  ...
  <p className="footer-copy">&copy; 2025 <strong>Aditi</strong>. All Rights Reserved.</p>
</footer>
